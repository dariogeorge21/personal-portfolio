...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      screens: {
        'lg': '940px', // This will make the hamburger appear below 940px
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic':
          'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'hero-pattern': 'url("https://images.pexels.com/photos/3863775/pexels-photo-3863775.jpeg?auto=compress&cs=tinysrgb&w=1600")',
      },
      boxShadow: {
